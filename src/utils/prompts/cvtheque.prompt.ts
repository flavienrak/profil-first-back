...
const cvThequeCirterePrompts = [
  {
    ...
    formation: `
      ...
      Format attendu:
      { content: "[Priorité] – [Thème professionnel valorisé, 5 à 8 mots] | [Organisme connu ou nom raccourci]\n  
  ...
  },
  {
    ...
    formation: `
      ...
      Format attendu:
      { content: "Expertise: [Domaine professionnel générique]\\n  
    ...
    competence: `
      ...
      Format attendu: 
      { content: "Compétence générique 1\\n  
  ...
  },
  {
    ...
    formation: `
      ...
      Format attendu: 
      { content: "[X] formations suivies dont une de [Nom de l’organisme reconnu]\\n  
    ...
    competence: `
      ...
      Format attendu: 
      { content: "Compétence de fonctionnement 1\\n  
