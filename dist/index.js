...
const quali_quarriere_routes_1 = __importDefault(require("./routes/quali-quarriere.routes"));
...
socket_1.app.use('/api/quali-carriere', auth_middleware_1.isAuthenticated, quali_quarriere_routes_1.default);
